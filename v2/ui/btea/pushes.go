...
func DefaultTitleFunc(desc ocispec.Descriptor) string {
	...
	case direct.MediaTypeLayerKernel:
		return "kernel"
	case direct.MediaTypeLayerInitrd, direct.MediaTypeLayerInitrdGzip, direct.MediaTypeLayerInitrdXz,
		direct.MediaTypeLayerInitrdLz4, direct.MediaTypeLayerInitrdZstd:
		return "initrd"
	case direct.MediaTypeConfig:
		return "config"
