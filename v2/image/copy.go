...
// copyPathOptions are options for the CopyGraph operation.
...
func copyPathGraph(ctx context.Context, src content.ReadOnlyStorage, dst content.Storage, path path, opts copyPathOptions) error {
